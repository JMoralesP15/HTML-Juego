...
const baseline=readJson('config/architecture-budget-v184.json');
...
const report={
  schema:'que-ano-architecture-budget-result-v1.8.4',
...
fs.writeFileSync(path.join(root,'reports','architecture-budget-v184.json'),JSON.stringify(report,null,2)+'\n');
