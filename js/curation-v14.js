/* QUÉ AÑO v1.4 — capa editorial de cultura general.
   No cambia IDs, años, scheduler ni calendario. Clasifica y estructura el contenido existente. */

const QA_V14_CURATION_VERSION='1.4-curation-1';
...
const QA_V14_NICHE_PATTERNS=[
  /in the aeroplane over the sea/i,
  /celeste|disco elysium|hades|baldur'?s gate 3|black myth.*wukong/i
];
...
function qaV14CultureAssessment(q){
  ...
  let score=diffBase+impact+globality+sourceBonus;
  let override=null;
